  ...
  it("booking.apply without trusted phone fires phone guard (PR #132/#133 regression)", async () => {
    ...
    const loop = createRuntimeAgentLoop({
      ...
      bookingProcessStateRepository: {
        async loadState() { return { selected_slot: { starts_at: "2026-07-11T14:00:00" }, last_available_slots: [{ starts_at: "2026-07-11T14:00:00" }], active_availability_evidence: { availability_call_id: "legacy_test_call", requested_date: "2026-07-11", requested_time: null, allowed_slot_keys: ["2026-07-11T14:00"] }, selected_slot_proof: { availability_call_id: "legacy_test_call", slot_key: "2026-07-11T14:00" } }; },
        async saveState() {},
      },
    });
