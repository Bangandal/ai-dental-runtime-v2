  ...
  it("blocks booking.apply when trusted phone is missing and asks for phone", async () => {
    ...
    const loop = createRuntimeAgentLoop({
      ...
      bookingProcessStateRepository: {
        async loadState() { return { selected_slot: { starts_at: "2026-07-04T13:00:00" }, last_available_slots: [{ starts_at: "2026-07-04T13:00:00" }], active_availability_evidence: { availability_call_id: "legacy_test_call", requested_date: "2026-07-04", requested_time: null, allowed_slot_keys: ["2026-07-04T13:00"] }, selected_slot_proof: { availability_call_id: "legacy_test_call", slot_key: "2026-07-04T13:00" } }; },
        async saveState() {},
      },
    });
