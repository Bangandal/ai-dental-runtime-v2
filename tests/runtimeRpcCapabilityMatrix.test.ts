...
test("PR scope guard: only docs/tests and targeted runtime repository files are modified", () => {
  ...
  const allowedNonDocTestFiles = new Set([
    ...
    "src/runtime/whatsappConfig.ts",
    "src/runtime/whatsappWebhookAdapter.ts",
    "src/runtime/whatsappSender.ts",
    "src/runtime/whatsappWebhookRoute.ts",
    "src/runtime/audioTranscription.ts",
    "src/runtime/telegramMediaResolver.ts",
    "src/runtime/whatsappMediaDownloader.ts",
    "Dockerfile",
    ".env.example",
