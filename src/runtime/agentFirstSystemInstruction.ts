...
export function buildAgentFirstSystemInstruction(legacyInstruction: string): string {
  return [
    ...
    "qualification: complaint (without diagnosis), reported_facts (array of patient-reported facts), summary (brief summary); include route, urgency and red_flags only when qualification_policy is present and supports them.",
